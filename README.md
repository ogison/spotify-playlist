...
- Next.js 16 App Router with React 19 and TypeScript already wired up.
...
- Turbopack-powered dev and build scripts for faster feedback loops.
...
- Root-level config files (tsconfig.json, eslint.config.mjs, postcss.config.mjs, etc.) are preconfigured for the stack above.
